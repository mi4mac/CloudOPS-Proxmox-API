...
For each operation there are **sample playbooks** in the collection `Sample - Proxmox VE Hypervisor - 1.0.0`. Token capabilities and permission requirements: `TOKEN_CAPABILITIES.md` in the project root.  
