...
- Prebuilt content:
  - **`CloudOPS_Solution_Pack.zip`** – All-in-one importable solution pack (built from this folder via `./build-pack.sh` in the repo root). Do not sync `CloudOPS Solution Pack Proxmox_Docker.zip` to git.
